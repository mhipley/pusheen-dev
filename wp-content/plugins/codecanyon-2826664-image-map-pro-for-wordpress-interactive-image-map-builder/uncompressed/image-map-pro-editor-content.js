;(function ( $, window, document, undefined ) {
    $.image_map_pro_editor_content = function() {
        ...
        if (parseInt(settings.layers.enable_layers, 10) == 1) {
            ...
            // Build select menu
            html += '<select id="select-canvas-layer" data-editor-object-type="8">';
        ...
        for (var i=0; i<settings.spots.length; i++) {
            ...
            if (parseInt(settings.layers.enable_layers, 10) == 1 && parseInt(s.layerID, 10) != parseInt(settings.editor.currentLayer)) continue;
